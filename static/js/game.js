...
function resetGame() {
    game = {
        ...
        flightAudio: document.getElementById('flightAudio'),
        crashAudio: document.getElementById('crashAudio'),
        coinAudio: document.getElementById('coinAudio'),
        collideAudio: document.getElementById('collideAudio'),
        blinkingAudio: document.getElementById('blinkingAudio'),
